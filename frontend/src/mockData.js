// Mock data para o site de afiliado Elephant Bet Angola

export const siteContent = {
  header: {
    logoUrl: "https://customer-assets.emergentagent.com/job_2c58c619-086b-4a15-9575-ceee5f3e35c3/artifacts/3jehks97_logo_elephantBet.png",
    logoAlt: "Elephant Bet Angola",
    navigation: [
  ...
  hero: {
    title: "Apostas Desportivas em Angola",
    subtitle: "Junte-se à Elephant Bet e aproveite as melhores odds do mercado angolano!",
    description: "Registe-se agora e receba bónus de boas-vindas. Apostas em futebol, basquetebol e muito mais.",
  ...
  about: {
    title: "Sobre a Elephant Bet Angola",
    description: "A Elephant Bet é a casa de apostas líder em Angola, oferecendo uma plataforma segura e confiável para apostas desportivas. Com anos de experiência no mercado angolano, proporcionamos as melhores odds, pagamentos rápidos e um serviço de atendimento ao cliente excepcional.",
    highlights: [
      {
        title: "Segurança",
        description: "Plataforma 100% segura e licenciada em Angola"
      },
      {
        title: "Variedade",
        description: "Centenas de eventos desportivos disponíveis diariamente"
      },
      {
        title: "Pagamentos",
        description: "Depósitos e levantamentos rápidos e seguros"
      },
      {
        title: "Suporte",
        description: "Atendimento em português 24 horas por dia"
      }
    ]
  },
  ...
  videos: {
    ...
    subtitle: "Aprenda passo a passo como utilizar a plataforma Elephant Bet",
    videoList: [
      {
        id: 1,
  ...
  steps: {
    title: "Passos Rápidos para Começar",
    stepsList: [
      {
        step: 1,
        title: "Criar Conta",
        description: "Clique em 'Registrar Agora' e preencha os seus dados"
      },
      {
        step: 2,
        title: "Fazer Depósito",
        description: "Deposite fundos usando um dos métodos disponíveis"
      },
      {
        step: 3,
        title: "Escolher Evento",
        description: "Navegue pelos eventos desportivos disponíveis"
      },
      {
        step: 4,
        title: "Fazer Aposta",
        description: "Selecione as suas odds e confirme a aposta"
      },
      {
        step: 5,
        title: "Acompanhar",
        description: "Acompanhe os resultados e receba os seus ganhos"
      }
    ]
  },
  ...
  faq: {
    ...
    subtitle: "Tudo o que precisa saber sobre a Elephant Bet",
    items: [
      {
        id: "criar-conta",
...
**Dúvidas?** Entre em contato pelo WhatsApp: +244 930 696 398`
  ...
  contact: {
    whatsapp: "+244930696398",
    whatsappMessage: "Olá! Gostaria de saber mais sobre a Elephant Bet.",
    supportText: "Precisa de ajuda? Fale connosco!"
  },

  footer: {
    copyright: "© Daniel António. Todos os direitos reservados.",
